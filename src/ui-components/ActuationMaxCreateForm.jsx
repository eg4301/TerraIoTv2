...
import { createActuationMax } from "../graphql/mutations";
const client = generateClient();
export default function ActuationMaxCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPesudoMax(initialValues.PesudoMax);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createActuationMax.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ActuationMaxCreateForm")}
      {...rest}
    >
      <TextField
        label="Max"
