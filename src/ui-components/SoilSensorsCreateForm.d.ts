...
export declare type SoilSensorsCreateFormInputValues = {
    CO2?: number;
    MAC?: number;
    O2?: number;
...
export declare type SoilSensorsCreateFormValidationValues = {
...
export declare type SoilSensorsCreateFormOverridesProps = {
    SoilSensorsCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type SoilSensorsCreateFormProps = React.PropsWithChildren<{
    overrides?: SoilSensorsCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: SoilSensorsCreateFormInputValues) => SoilSensorsCreateFormInputValues;
    onSuccess?: (fields: SoilSensorsCreateFormInputValues) => void;
    onError?: (fields: SoilSensorsCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: SoilSensorsCreateFormInputValues) => SoilSensorsCreateFormInputValues;
    onValidate?: SoilSensorsCreateFormValidationValues;
} & React.CSSProperties>;
export default function SoilSensorsCreateForm(props: SoilSensorsCreateFormProps): React.ReactElement;
