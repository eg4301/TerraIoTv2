...
import { createSoilSensors } from "../graphql/mutations";
const client = generateClient();
export default function SoilSensorsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setNitrogen(initialValues.Nitrogen);
    setPhosphorous(initialValues.Phosphorous);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSoilSensors.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SoilSensorsCreateForm")}
      {...rest}
    >
      <TextField
        label="Co2"
